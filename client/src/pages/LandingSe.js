        ...
        <div className="container page">
          <div className="info">
            ...
            <p>
              ...
              överblick över alla dina arbetsansökningar, viktig information för
              varje enskild ansökan samt månadsstatistiken för de senaste sex
              månaderna.
            </p>
            <footer>
